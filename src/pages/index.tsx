      ...
      <Layout title="Home">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="bg-white p-16 md:px-28">
            ...
            <div className="grid grid-cols-1 mt-16 gap-6 md:grid-cols-2 lg:grid-cols-2">
              ...
              <div className="rounded-lg bg-white p-6 shadow-lg">
                ...
                <p className="text-gray-600">
                  Our people are our best assets. We collaborate accross all
                  levels and respect diverse contributions.
                </p>
              </div>
              <div className="rounded-lg bg-white p-6 shadow-lg">
                <h3 className="mb-2 text-xl font-bold">
                ...
                <p className="text-gray-600">
                  We are continuous learners. W review processes and research
              ...
              <div className="rounded-lg bg-white p-6 shadow-lg">
                ...
                <p className="text-gray-600">
                  We set clear expectations and goals with everything we do. We
                  are positive, strategic, and focused on achieving excellence.
                </p>
              </div>
            </div>
          </div>
